...
description: "High-performance computing tools for quantum error correction simulation, including GPU-accelerated Pauli frame simulation."
thumbnail: /projects/hpc/images/FlexibleQECSim.png
---
...
<div style="text-align: center;">
  <img src="/projects/hpc/images/FlexibleQECSim.png" style="max-width: 500px; width: 100%;" loading="lazy" alt="Organization of the package FlexibleQECSim">
  <p>Organization of the package. Text in green are features not implemented yet.</p>
</div>

<div style="text-align: center;">
  <img src="/projects/hpc/images/importance.png" style="max-width: 800px; width: 100%;" alt="Example of importance sampling usage" loading="lazy">
...
<div style="text-align: center;">
  <img src="/projects/hpc/images/GPU_pauli_frame.png" style="max-width: 500px; width: 100%;" loading="lazy" alt="GPU Pauli frame simulation">
  <p>preview.</p>
</div>

<div style="text-align: center;">
  <img src="/projects/hpc/images/GPU_ILP.png" style="max-width: 500px; width: 100%;" loading="lazy" alt="GPU Pauli frame simulation instruction level parallelism">
  <p>preview.</p>
</div>

<div style="text-align: center;">
  <img src="/projects/hpc/images/GPU_demo_testing.png" style="max-width: 500px; width: 100%;" loading="lazy" alt="preliminary results on speed up">
  <p>preview.</p>
</div>

<div style="text-align: center;">
  <img src="/projects/hpc/images/GPU_compile.png" style="max-width: 500px; width: 100%;" loading="lazy" alt="compiling from stim and GPU simulator source code">
  <p>preview.</p>
</div>
---
...
<div style="text-align: center;">
  <img src="/projects/hpc/images/CoupledQuantumSystems.png" style="max-width: 500px; width: 100%;" loading="lazy" alt="Organization of the package CoupledQuantumSystems">
  <p>Organization of the package. Text in green are features not implemented yet.</p>
</div>
